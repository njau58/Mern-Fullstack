...
const About = () => {
    ...
    return (
		<div  style={{marginTop:'-80px', maxWidth:'70%'}}  className="container">
			...
			<p  style={{lineHeight:'25px', fontSize:'1.5rem',fontFamily:'Ms'}}>CRUD is a fullstack application that follows common patterns in modern web applications in the MERN stack.The app facilitates registration and login.
